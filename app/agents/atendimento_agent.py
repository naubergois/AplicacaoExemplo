...
class AtendimentoAgent:
    ...
    def respond(
        ...
        return texto or (
            "Consegui reunir as informacoes disponiveis, mas preciso de um detalhe adicional "
            "para concluir. Pode me dizer a cidade, origem/destino ou data que deseja consultar?"
        )
